<template>
  <div id="sign-up-container">
    <form id="signup-form" @submit.prevent="signup">
      ...
      <input id="signup-input" type="email" placeholder="Please input your email" v-model="email">
      <label id="signup-label" for="signup-input">Password:</label>
      <input id="signup-input" type="password" placeholder="Please input your password" v-model="password">
    ...
    signup () {
      this.$store.dispatch('signup', {
        ...
        .then(({ data }) => {
          ...
          this.$router.push('/dashboard')
          this.$toasted.success('welcome to e-commerce client!')
          console.log(data)
        })
        .catch(error => {
